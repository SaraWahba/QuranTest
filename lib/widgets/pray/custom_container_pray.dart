...
class CustomContainerPray extends StatelessWidget {
  const CustomContainerPray({super.key, required this.themeApp, required this.prayModel});
        ...
        children: [
          Row(
            ...
            children: [
              InkWell(
                onTap: () {
                 Share.share(prayModel.text.toString());
                },
              ...
              InkWell(
                onTap: () async {
                  ...
                  await FlutterClipboard.copy(prayModel.text.toString());
